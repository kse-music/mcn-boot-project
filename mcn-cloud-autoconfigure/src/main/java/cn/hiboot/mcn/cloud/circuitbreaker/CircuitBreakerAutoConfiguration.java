...
@ConditionalOnClass(CustomResilience4JCircuitBreakerFactory.class)
@ConditionalOnProperty(prefix = "mcn.circuitbreaker", name = "default.enabled", havingValue = "true", matchIfMissing = true)
public class CircuitBreakerAutoConfiguration {

    @Bean
    CustomResilience4JCircuitBreakerFactory resilience4jCircuitBreakerFactory(CircuitBreakerRegistry circuitBreakerRegistry, TimeLimiterRegistry timeLimiterRegistry,
        ...
        return new CustomResilience4JCircuitBreakerFactory(circuitBreakerRegistry,
