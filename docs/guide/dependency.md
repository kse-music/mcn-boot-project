...
| spring-boot-admin-starter-client     | boot-admin.version           |      3.5.6       |
| spring-boot-admin-starter-server     | boot-admin.version           |      3.5.6       |
...
| springdoc-openapi-starter-webflux-ui | springdoc.version            |      2.8.14      |
