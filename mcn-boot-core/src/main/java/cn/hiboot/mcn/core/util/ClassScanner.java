 ...
 * 类扫描器，扫描给定包及其子包中的所有类
 * @author DingHao
 * @since 2020/11/8 16:35
 *
 */
public class ClassScanner {

    /**
     * 从包package中获取Class(不递归)
     * @param pkg 包名
     * @return 当前路径下所有class
     */
     ...
     * @param pkg 包名
     * @return 当前路径下以及子包下所有class
     */
    public static Set<Class<?>> getAllClasses(String pkg) {
        return getClasses(pkg,true);
    }

    private static Set<Class<?>> getClasses(String pkg,boolean recursive) {
