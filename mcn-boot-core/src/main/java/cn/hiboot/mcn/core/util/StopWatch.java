...
public class StopWatch {
    ...
    public String prettyPrint(boolean inMillis) {
        ...
        if (!this.keepTaskList) {
            ...
            sb.append("---------------------------------------------\n");
            sb.append(inMillis?"ms":"ns").append("         %     Task name\n");
            sb.append("---------------------------------------------\n");
...
//            nf.setGroupingUsed(false);
            ...
            for (TaskInfo task : getTaskInfo()) {
                sb.append(inMillis?task.getTimeMillis():task.getTimeNanos()).append("  ");
